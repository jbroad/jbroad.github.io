...
<div class="section">
<h8 style="color: none; border-bottom: 5px solid white;">CODING</h8>
...
<div class="section">
<h8 style="color: rgba(0,0,0,0); border-bottom: 5px solid white;">CODING</h8>
<div class="section" id="crow" style="margin-top: 30px;">
<div class="row" id="ccircle">
<a href="https://josephbroad.shinyapps.io/stats/"><img class="static" style="padding: 10px 0 10px 0;" src="images/AZmap_static.jpg">
